...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('tirage_lots', [
      ...
      { tirage_id: TIR.SH_1, lot_id: LOT.SH_MOET,    order: 0, created_at: past(90), updated_at: past(90) },
      { tirage_id: TIR.SH_2, lot_id: LOT.SH_SPA,     order: 0, created_at: past(90), updated_at: past(90) },
      { tirage_id: TIR.SH_3, lot_id: LOT.SH_DECATHL, order: 0, created_at: past(90), updated_at: past(90) },
      { tirage_id: TIR.SH_4, lot_id: LOT.SH_COOKEO,  order: 0, created_at: past(90), updated_at: past(90) },
      { tirage_id: TIR.SH_5, lot_id: LOT.SH_VELO,    order: 0, created_at: past(90), updated_at: past(90) },
      { tirage_id: TIR.SH_6, lot_id: LOT.SH_TV,      order: 0, created_at: past(90), updated_at: past(90) },

      // Bordeaux Automne 25
      { tirage_id: TIR.BA_1, lot_id: LOT.BA_RESTAU,    order: 0, created_at: past(60), updated_at: past(60) },
      { tirage_id: TIR.BA_2, lot_id: LOT.BA_NESPRESSO, order: 0, created_at: past(60), updated_at: past(60) },
      { tirage_id: TIR.BA_3, lot_id: LOT.BA_JBL,       order: 0, created_at: past(60), updated_at: past(60) },
      { tirage_id: TIR.BA_4, lot_id: LOT.BA_AIRFRYER,  order: 0, created_at: past(60), updated_at: past(60) },
      { tirage_id: TIR.BA_5, lot_id: LOT.BA_WEEKEND,   order: 0, created_at: past(60), updated_at: past(60) },
      { tirage_id: TIR.BA_6, lot_id: LOT.BA_IPAD,      order: 0, created_at: past(60), updated_at: past(60) },
      { tirage_id: TIR.BA_7, lot_id: LOT.BA_PS5,       order: 0, created_at: past(60), updated_at: past(60) },

      // Lyon Noël 25
      { tirage_id: TIR.LN_1, lot_id: LOT.LN_WHISKY,  order: 0, created_at: past(30), updated_at: past(30) },
      { tirage_id: TIR.LN_2, lot_id: LOT.LN_AMAZON,  order: 0, created_at: past(30), updated_at: past(30) },
      { tirage_id: TIR.LN_3, lot_id: LOT.LN_GOURMET, order: 0, created_at: past(30), updated_at: past(30) },
      { tirage_id: TIR.LN_4, lot_id: LOT.LN_INSTAX,  order: 0, created_at: past(30), updated_at: past(30) },
      { tirage_id: TIR.LN_5, lot_id: LOT.LN_SONY,    order: 0, created_at: past(30), updated_at: past(30) },

      // Nantes Running — 1 terminé + 4 planifiés avec lots (NA_3 = pause, pas de lot)
      { tirage_id: TIR.NA_1, lot_id: LOT.NA_LG_TV,      order: 0, created_at: past(2), updated_at: past(2) },
      { tirage_id: TIR.NA_2, lot_id: LOT.NA_VIN,        order: 0, created_at: past(2), updated_at: past(2) },
      { tirage_id: TIR.NA_4, lot_id: LOT.NA_DECATHL,    order: 0, created_at: past(2), updated_at: past(2) },
      { tirage_id: TIR.NA_5, lot_id: LOT.NA_WEEKEND,    order: 0, created_at: past(2), updated_at: past(2) },
      { tirage_id: TIR.NA_5, lot_id: LOT.NA_TROTTINETTE,order: 1, created_at: past(2), updated_at: past(2) },
      { tirage_id: TIR.NA_6, lot_id: LOT.NA_THERMOMIX,  order: 0, created_at: past(2), updated_at: past(2) },

      // Toulouse Printemps — multi-lots sur les cartons pleins
      { tirage_id: TIR.TL_1, lot_id: LOT.TL_BON,     order: 0, created_at: past(5), updated_at: past(5) },
      { tirage_id: TIR.TL_2, lot_id: LOT.TL_AIRFRYER, order: 0, created_at: past(5), updated_at: past(5) },
      { tirage_id: TIR.TL_3, lot_id: LOT.TL_SWITCH,   order: 0, created_at: past(5), updated_at: past(5) },
      { tirage_id: TIR.TL_4, lot_id: LOT.TL_SEJOUR,   order: 0, created_at: past(5), updated_at: past(5) },
      { tirage_id: TIR.TL_5, lot_id: LOT.TL_VELO,     order: 0, created_at: past(5), updated_at: past(5) },
      { tirage_id: TIR.TL_6, lot_id: LOT.TL_IPHONE,   order: 0, created_at: past(5), updated_at: past(5) },

      // Marseille Été
      { tirage_id: TIR.MA_1, lot_id: LOT.MA_BON,      order: 0, created_at: past(3), updated_at: past(3) },
      { tirage_id: TIR.MA_2, lot_id: LOT.MA_ROOMBA,   order: 0, created_at: past(3), updated_at: past(3) },
      { tirage_id: TIR.MA_3, lot_id: LOT.MA_BBQ,      order: 0, created_at: past(3), updated_at: past(3) },
      { tirage_id: TIR.MA_4, lot_id: LOT.MA_TV,       order: 0, created_at: past(3), updated_at: past(3) },
      { tirage_id: TIR.MA_5, lot_id: LOT.MA_CROISIERE,order: 0, created_at: past(3), updated_at: past(3) },

      // Strasbourg Pâques
      { tirage_id: TIR.ST_1, lot_id: LOT.ST_CULTURA,    order: 0, created_at: past(4), updated_at: past(4) },
      { tirage_id: TIR.ST_2, lot_id: LOT.ST_BIERES,     order: 0, created_at: past(4), updated_at: past(4) },
      { tirage_id: TIR.ST_3, lot_id: LOT.ST_TABLET,     order: 0, created_at: past(4), updated_at: past(4) },
      { tirage_id: TIR.ST_4, lot_id: LOT.ST_WEEKEND,    order: 0, created_at: past(4), updated_at: past(4) },
      { tirage_id: TIR.ST_5, lot_id: LOT.ST_KITCHENAID, order: 0, created_at: past(4), updated_at: past(4) },

      // Saintes Été 26
      { tirage_id: TIR.SE_1, lot_id: LOT.SE_DECATHL, order: 0, created_at: past(7), updated_at: past(7) },
      { tirage_id: TIR.SE_2, lot_id: LOT.SE_LEURRES, order: 0, created_at: past(7), updated_at: past(7) },
      { tirage_id: TIR.SE_3, lot_id: LOT.SE_GLACIERE, order: 0, created_at: past(7), updated_at: past(7) },
      { tirage_id: TIR.SE_4, lot_id: LOT.SE_CANNE,   order: 0, created_at: past(7), updated_at: past(7) },
      { tirage_id: TIR.SE_5, lot_id: LOT.SE_COMBI,   order: 0, created_at: past(7), updated_at: past(7) },
    ]);
  },
